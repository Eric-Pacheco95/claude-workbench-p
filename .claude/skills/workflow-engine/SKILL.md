...
- /workflow-engine deep-analysis "Should your AI brain adopt LangGraph?"
- /workflow-engine build-feature docs/dashboard/PRD.md
...
**`improve-system`** — Review and improve your AI brain itself
```
```
