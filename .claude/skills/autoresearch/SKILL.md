...
- /autoresearch --program docs/autoresearch_program.md
...
- Side effects: creates git branch, modifies scoped files, writes report to docs/autoresearch/
...
Write to `docs/autoresearch/YYYY-MM-DD_{slug}/report.md`:
...
- Confirm the report file was written to docs/autoresearch/YYYY-MM-DD_{slug}/report.md
