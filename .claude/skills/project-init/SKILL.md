...
- Side effects: PRD saved to docs/{slug}/PRD.md, project registered in orchestration/tasklist.md, project state created at docs/{slug}/project_state.md
...
1. Check if a research brief already exists at `docs/{slug}/research_brief.md`
...
8. PRD is saved to `docs/{slug}/PRD.md`

9. Register the project in your AI brain orchestration:
   - Add to `orchestration/tasklist.md` Active Projects table
   - Create `docs/{slug}/project_state.md` with ISC checklist
   - Add CLAUDE.md to the project repo if it's a separate codebase

## Phase 4.5: VISUALIZE (optional)

9.5. After PRD is saved, offer: "Want a `/visualize project` diagram showing the project structure, dependencies, and phase map?" — invoke `/visualize` only if the user accepts
...
### OBSERVE
- Brief: `docs/{slug}/research_brief.md`
...
### BUILD
- PRD: `docs/{slug}/PRD.md`
- ISC registered: `orchestration/tasklist.md`

### Next Steps
1. {First concrete action}
2. {Second concrete action}
3. {Who implements — Cursor or your AI brain?}
```
...
- Read existing `docs/{slug}/research_brief.md`
...
- If any phase produces a blocking finding (e.g. red-team says "this is a commodity with no edge"), surface it explicitly and ask the user whether to continue
- Always end with a clear "Next Steps" block naming who does what (Cursor vs your AI brain)
