...
## Examples
- /validation --prd docs/isc-validation/PRD.md
- /validation --prd docs/jarvis/PRD.md
- /validation --prd docs/foo/PRD.md --json
...
- /validation --prd docs/foo/PRD.md --normal
...
- Capture the full output and display it to the user verbatim
...
- **format-gate-fail:** quality gate exits 1 -- print gate output, instruct the user to fix criteria
...
Await --prd argument from the user. If not provided, print usage and stop.
